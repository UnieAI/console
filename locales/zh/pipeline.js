...
module.exports = {
  ...
  dir: '切换目录',
  Discard: '忽略',
  'Discover branches from repository': '發現仓库上的分支',
  DISCOVER_PR_FROM_FORKS: '从 Fork 仓库發現 PR',
  DISCOVER_PR_FROM_ORIGIN: '从原仓库發現 PR',
  'Discover pull requests from forks': '發現 Fork 存储库与目标存储库相同的 PR',
  'Discover pull requests from origin': '發現原始存储库与目标存储库相同的 PR',
  ...
  PIPELINE_NO_CONFIG: '当前流水线中并未發現相关配置文件',
