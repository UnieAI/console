...
module.exports = {
  ...
  APPLICATIONS_DESC:
    'Una aplicación proporciona a los usuarios funciones comerciales integrales en un solo paquete. Las plantillas de aplicación en UWS se basan en la especificación de empaquetado de Helm. Se entregan a través de un repositorio Helm público o privado unificado. Una aplicación está compuesta por uno o más objetos de Kubernetes, que incluyen workload, servicios e ingress.',
  APP_PL: 'Aplicaciones',
  APP_TYPES_Q: 'tipo de aplicacion',
  APP_TYPES_A:
    'UWS admite implementaciones de aplicaciones (basadas en Helm) desde App Store, así como Application CRD.',
  ...
  TEMPLATE_BASED_APP_EMPTY_DESC: 'Please create an app from the UWS App Store or an app template.',
  APP: 'App',
  VERSION: 'Versión',
  CREATING: 'Creating',
  UPGRADING: 'Created',
  ...
  FROM_APP_STORE_DESC:
    'Desde la tienda de aplicaciones oficial de UWS con aplicaciones de alta calidad y despliegues fáciles.',
  ...
  APP_TEMPLATES_MODAL_DESC:
    'La plantilla de la aplicación proviene del espacio de trabajo y las plantillas de aplicación de Helm de terceros. Admite el despliegue con un click y se puede visualizar en UWS para mostrar y proporcionar despliegues y funciones de administración.',
