...
module.exports = {
  ...
  SERVICE_COMPONENTS_DESC:
    'Este módulo monitorea el estado de varios componentes del servicio en UWS, Kubernetes, OpenPitrix, etc. Muestra el estado de mantenimiento y el tiempo de ejecución del clúster actual, y ayuda a los usuarios a monitorear el estado del clúster y localizar problemas a tiempo.',
  // UWS
  STOPPED: 'Stopped',
  RUNNING_TIME: 'Tiempo de ejecución',
  KS_CONSOLE_DESC: 'Proporciona servicios de consola para UWS.',
  KS_APISERVER_DESC:
