...
module.exports = {
  ...
  PROJECTS_DESC:
    'Un proyecto es un namespace de Kubernetes en UWS, que proporciona un mecanismo para organizar los recursos en un espacio de trabajo.',
  ...
  PROJECT_TYPES_PROJECT_DESC:
    'El proyecto en UWS corresponde al namespace de Kubernetes, que es una colección abstracta de un conjunto de recursos y objetos que se pueden agrupar de acuerdo con diferentes unidades de negocio o proyectos de productos.',
