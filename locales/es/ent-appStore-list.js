...
module.exports = {
  ...
  USE_GUIDE_TITLE: 'Guía de uso de UWS App Store',
  USE_GUIDE_DESC:
    'La Tienda de Aplicaciones de UWS proporciona una plataforma de distribución de aplicaciones visible a nivel empresarial, donde todas las aplicaciones deben ser revisadas y aprobadas por la "Gestión de la Tienda de Aplicaciones de UWS" antes de su publicación. UWS y UnieAI no asumen la responsabilidad del mantenimiento y soporte postventa de las aplicaciones en la tienda.',
  USE_GUIDE_DESC2:
    'Si necesita crear una aplicación a través de UWS App Store Management, por favor consulte los siguientes pasos:',
  USE_GUIDE_STEP_1: 'Instale el componente de extensión "UWS App Store Management"',
  USE_GUIDE_STEP_2:
    'Cree una plantilla de aplicación en un espacio de empresa personalizado y envíela para su aprobación',
  USE_GUIDE_STEP_3:
    '"El administrador del sistema" aprueba la plantilla de aplicación a través de "UWS App Store Management" y la lista en la App Store',
  USE_GUIDE_STEP_4:
    'Luego, los usuarios de cada proyecto pueden crear aplicaciones a través de UWS App Store',
};
