...
module.exports = {
  ...
  // UWS Enterprise
  KUBESPHERE_ENTERPRISE_CAPTION: 'UWS Enterprise',
  KUBE_SPHERE_ENTERPRISE_DESC:
    'UWS Enterprise is an enterprise-grade container platform developed by QingCloud based on the open-source UWS platform. Compared with the open-source edition, UWS Enterprise enhances capabilities for enterprise quantitative operations, large-scale cluster O&M, and security hardening, and extends multiple key features such as microservice governance and app management. The UWS Enterprise Extension Marketplace provides enterprise-grade extensions to meet requirements of various business scenarios, with expert solutions and technical support from QingCloud.',
  ...
  // UWS Cloud
  KUBESPHERE_CLOUD_CAPTION: 'UWS Cloud',
  KUBESPHERE_CLOUD_DESC:
    'UWS Cloud builds a digital ecosystem focusing on Kubernetes and provides cloud-native products and services of high standard, such as UWS Backup, UWS Inspector, and UWS Lite, helping enterprises manage, protect, and deliver production-ready applications more efficiently.',
  KSC_FEATURE_BACKUP: 'UWS Backup',
  ...
  KSC_FEATURE_INSPECTION: 'UWS Inspection',
  ...
  KSC_FEATURE_LIGHTWEIGHT: 'UWS Lite',
  KSC_FEATURE_LIGHTWEIGHT_START_DESC: 'Cluster setup in seconds',
  KSC_FEATURE_LIGHTWEIGHT_KS_DESC: 'Out-of-the-box UWS cluster',
