...
module.exports = {
  ...
  STORAGE_CLASS_SET_DEFAULT_DESC:
    '设置为默认存储类后，如果没有特殊指定，系统将使用默认存储类创建卷。一个 UWS 集群中仅允许设置一个默认存储类。',
  ...
  AUTHORIZATION_NOT_SUPPORT:
    '当前集群不支持此功能。请升级 UWS 到 v3.3.0 或更高版本，或者手动安装 <a href="https://github.com/kubesphere/storageclass-accessor" target="_blank">storageclass-accessor</a>。',
  OPERATOR_IN: '属于',
  OPERATOR_NOT_IN: '不属于',
