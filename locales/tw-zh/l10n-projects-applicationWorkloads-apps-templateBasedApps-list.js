...
module.exports = {
  ...
  APP_TYPES_A: 'UWS 支持基于模板的应用。基于模板的应用创建自 UWS 应用商店或应用模板。',
  ...
  TEMPLATE_BASED_APP_EMPTY_DESC: '请从 UWS 应用商店或应用模板创建应用。',
  APP: '应用',
  VERSION: '版本',
  CREATING: '创建中',
  UPGRADING: '已创建',
  ...
  // List > Create
  CREATE_APP: '创建应用',
  CREATE_APP_DESC: '从 UWS 应用商店或应用模板创建应用。',
  FROM_APP_STORE: '从应用商店',
  FROM_APP_TEMPLATE: '从应用模板',
  FROM_APP_STORE_DESC: '从 UWS 应用商店创建应用。',
