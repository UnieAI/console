...
module.exports = {
  ...
  ROLE_USERS_MANAGER: '管理 UWS 平台上的所有用户。',
  ROLE_WORKSPACES_MANAGER: '管理 UWS 平台上的所有企业空间。',
  ROLE_PLATFORM_ADMIN: '管理 UWS 平台上的所有资源。',
  ...
  PERMISSION_PLATFORM_SETTINGS_MANAGEMENT_DESC: '查看和编辑 UWS平台的设置。',
