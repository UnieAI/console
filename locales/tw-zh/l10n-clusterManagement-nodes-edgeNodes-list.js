...
module.exports = {
  ...
  EDGE_NODE_PL: '边缘节点',
  EDGE_NODE_DESC:
    '边缘节点是部署在 UWS 集群外部的服务器，您可以将边缘节点添加到 UWS 集群以对其进行管理。',
  // Node Count
  // List
  ...
  EDGENODE_INTERNAL_IP_DESC: '设置边缘节点在 UWS 集群内部的 IP 地址。',
  EDGENODE_INTERNAL_IP_EMPTY_DESC: '请设置边缘节点在 UWS 集群内部的 IP 地址。',
