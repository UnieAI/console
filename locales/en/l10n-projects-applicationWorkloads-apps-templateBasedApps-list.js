...
module.exports = {
  ...
  APPLICATIONS_DESC:
    'An app provides users with comprehensive business functions in one package. App templates in UWS are built on the Helm packaging specification. They are delivered through a unified public or private Helm repository. An app is composed of one or more Kubernetes objects including workloads, services and ingresses.',
  APP_PL: 'Apps',
  APP_TYPES_Q: 'What app types does UWS support?',
  APP_TYPES_A:
    'UWS supports templated-based apps. Template-based apps are created from You can deploy apps from the UWS App Store or an app template.',
  ...
  CREATE_APP_DESC: 'Create an app from the UWS App Store or an app template.',
  FROM_APP_STORE: 'From App Store',
  FROM_APP_TEMPLATE: 'From App Template',
  FROM_APP_STORE_DESC: 'Create an app from the UWS App Store.',
