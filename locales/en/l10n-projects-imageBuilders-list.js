...
module.exports = {
  ...
  TRIGGER_TOKEN_DESC:
    'Set a token used to authenticate a client against UWS. You can set a client to automatically trigger image building on UWS over a webhook. The token can contain only uppercase letters, lowercase letters, and numbers.',
