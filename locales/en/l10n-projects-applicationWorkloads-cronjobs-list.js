...
module.exports = {
  ...
  CRONJOB_CRON_DESC:
    'Set a schedule for the cronjob. UWS uses UTC by default and you need to adjust the schedule according to your time zone. <a href="//en.wikipedia.org/wiki/Cron" target="_blank">Learn More</a>',
