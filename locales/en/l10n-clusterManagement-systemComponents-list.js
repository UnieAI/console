...
module.exports = {
  ...
  SERVICE_COMPONENTS_DESC:
    'System components are software components in the UWS system, which provide various functions. You can view the running status of services components on this page.',
  // UWS
  STOPPED: 'Stopped',
  RUNNING_TIME: 'Running time',
  KS_CONSOLE_DESC: 'Provides UWS console services.',
  KS_APISERVER_DESC:
