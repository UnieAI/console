...
module.exports = {
  ...
  WORKSPACE_CONSUMPTION: '企業雲(項目)資源消費情況',
  WORKSPACE_CONSUMPTION_DESC:
    '企業雲(項目)資源消費情況以企業雲為維度統計企業雲和項目的CPU、內存、存儲等資源消費情況',
  WORKSPACE_RESOURCE_CONSUMPTION_DESC:
    '<strong>企業雲</strong> 的CPU、內存、存儲等資源消費情況',
  WORKSPACE_PROJECT_CONSUMPTION_DESC:
    '企業雲中的 <strong>項目</strong> 的CPU、內存、存儲等資源消費情況',
