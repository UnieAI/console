...
module.exports = {
  ...
  // List > View YAML
  // Assign Workspace
  IPPOOL_ASSIGN_WORKSPACE_DESC: 'IP 地址範圍分配给企業雲之後才能被企業雲使用。',
  IPPOOL_ASSIGN_WORKSPACE_ALLOCATED_WARNING:
    'IP 地址範圍已被使用，無法分配给某一個具體的企業雲',
  IPPOOL_ASSIGN_WORKSPACE_CHANGE_WARNING:
    'IP 地址範圍已被使用，且已指定具體的企業雲，無法更改目標企業雲',
  ASSIGN_WORKSPACE: '分配企業雲',
  SELECT_WORKSPACE_DESC: '選擇一個企業雲',
  // List > Delete
