...
module.exports = {
  ...
  WORKSPACE_ROLE_DESC: '企業角色定義了在目前企業雲下用戶所擁有的權限。',
  // List
  WORKSPACE_ROLE_EMPTY_DESC: 'Please create a workspace role.',
  ROLE_WORKSPACE_ADMIN: '企業雲管理員，可以管理企業雲下所有的資源。',
  ROLE_WORKSPACE_REGULAR: '企業雲普通成員，無法創建 DevOps 项目和項目。',
  ROLE_WORKSPACE_VIEWER: '企業雲的觀察者，可以查看企業雲下所有的資源資訊。',
  ROLE_WORKSPACE_SELF_PROVISIONER:
    '企業雲普通成員，可以在企業雲下創建 DevOps 项目和項目。',
  // List > Create
  ...
  PROJECTS_VIEW: '項目查看',
  PROJECTS_MANAGEMENT_DESC: '管理企業雲裡的所有項目，可以 創建/編輯/刪除 項目',
  PROJECTS_CREATE_DESC: '擁有創建項目的權限，項目管理員只能為創建者自己',
  PROJECTS_VIEW_DESC: '可以查看企業雲裡的所有項目',
  ...
  DEVOPS_MANAGEMENT_DESC:
    '管理企業雲裡的所有 DevOps 项目，可以 創建/編輯/刪除 DevOps 项目',
  DEVOPS_CREATE_DESC:
    '擁有創建DevOps 项目的權限，DevOps 项目管理員只能為創建者自己',
  DEVOPS_VIEW_DESC: '可以查看企業雲裡的所有DevOps 项目',
  ...
  WORKSPACE_APP_TEMPLATES_VIEW_DESC: '查看企業雲應用模板',
  WORKSPACE_APP_TEMPLATES_MANAGEMENT_DESC:
    '上传/編輯/刪除 企業雲應用模板，上架/下架應用到平台的應用商店',
  ...
  WORKSPACE_ROLES_VIEW_DESC: '查看企業雲角色',
  WORKSPACE_ROLES_MANAGEMENT_DESC:
    '可以 創建/編輯/刪除 企業雲角色，系統預設角色無法刪除',
  WORKSPACE_MEMBERS_VIEW_DESC: '查看企業雲成員',
  WORKSPACE_MEMBERS_MANAGEMENT_DESC: '邀請/編輯/移除企業雲成員',
  // List > Create > Edit Permissions > Workspace Settings
  WORKSPACE_SETTINGS_VIEW: '企業雲設置查看',
  WORKSPACE_SETTINGS_MANAGEMENT: '企業雲設置管理',
  WORKSPACE_SETTINGS_DESC: '管理企業雲設置，編輯企業雲信息、網絡策略等',
  WORKSPACE_SETTINGS_VIEW_DESC: '查看企業雲設置',
  WORKSPACE_SETTINGS_MANAGEMENT_DESC:
    '管理企業雲設置，編輯企業雲信息、網絡策略等',
}
