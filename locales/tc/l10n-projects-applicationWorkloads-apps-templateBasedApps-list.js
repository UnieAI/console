...
module.exports = {
  ...
  APP_PL: '應用',
  APP_TYPES_Q: '應用類型',
  APP_TYPES_A: 'UWS 支持來自於應用商店和應用倉庫的應用部署(基於 Helm)。',
  ...
  FROM_APP_STORE_DESC: '來自UWS官方應用商店，提供高質量應用和簡易的部署方式',
  ...
  APP_TEMPLATES_MODAL_DESC:
    '應用模板來自於企業空間和第三方的 Helm 應用模板，支持一鍵部署並可通過視覺化的方式在 UWS 中展示並提供部署及管理的功能',
