...
const getStateStyles = (checked: boolean, indeterminate: boolean) => {
  if (checked) {
    return css`
      border-color: transparent;
      background-color: rgb(83, 39, 241) !important;
...
const CheckboxControl = styled('div')<ControlProps>`
  ...
  ${({ checked, indeterminate }) => getStateStyles(checked ?? false, indeterminate ?? false)};
